...
export async function GET(
    ...
    try {
        ...
        console.log('app/api/storeid/products/[productId]/route, GET', error);
...
export async function PATCH(
    ...
    try {
        ...
        console.log('app/api/storeId/products/[productId]/route, PATCH', error);
        return new NextResponse('Internal Error', { status: 500 });
    }
}
...
export async function DELETE(
    ...
    try {
        ...
        console.log(
            'app/api/storeid/products/[productId]/route, DELETE',
            error,
        );
        return new NextResponse('Internal Error', { status: 500 });
    }
